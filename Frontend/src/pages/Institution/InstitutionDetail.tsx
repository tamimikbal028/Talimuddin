...
import { useInstitutionHeader } from "../../hooks/useInstitution";
...
// Migrated University Components
import InstitutionMore from "../University/More";
...
const InstitutionDetail: React.FC = () => {
  ...
  const institution = headerResponse?.data?.institution;
  ...
  if (headerError || !institution || !meta) {
    return (
      <div className="flex flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <p className="mt-2 text-gray-500">
          The institution you are looking for does not exist or has been
          deactivated.
        </p>
        <button
  ...
  return (
    <div className="min-h-screen space-y-5">
      <InstitutionHeader institution={institution} meta={meta} />
